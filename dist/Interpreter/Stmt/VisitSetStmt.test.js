...
describe('when given a set statement', () => {
    ...
    test('should set foo to bar', async () => {
        ...
        await interpreter.visitSetStmt(new AST_1.SetStmt(fooToken, new AST_1.LiteralExpr('flim')));
        expect(MockEnvironment_1.default.assign).toBeCalledWith(fooToken, 'flim');
    });
});
